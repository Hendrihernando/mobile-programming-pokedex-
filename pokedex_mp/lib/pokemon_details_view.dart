import 'package: pokedex_mp/bloc/pokemon_details_cubit.dart';
...
class PokemonDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Color(0xFFE2CCCC),
  ...
  Widget _pokemonTypeView(String type) {
    ...
    switch (type) {
      case 'normal':
        ...
        break;
      case 'poison':
        color = Color(0xFFCE09CD);
        break;
      case 'psychic':
        color = Color(0xFFE96EB0);
        break;
      case 'grass':
        color = Color(0xFF336500);
        break;
      case 'ground':
      ...
      case 'ice':
        ...
        break;
      case 'fire':
        color = Color(0xFFFC2909);
        break;
      case 'rock':
        color = Color(0xFF9E9771);
        break;
      case 'dragon':
        color = Color(0xFF6D5CFD);
        break;
      case 'water':
        color = Color(0xFF6DACF8);
        break;
      case 'bug':
        color = Color(0xFFD0E700);
        break;
      case 'dark':
        color = Color(0xFF402F27);
        break;
      case 'fighting':
        color = Color(0xFFA0412B);
        break;
      case 'ghost':
        color = Color(0xFF282471);
        break;
      case 'steel':
